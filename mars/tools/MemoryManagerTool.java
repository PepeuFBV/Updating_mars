...
public class MemoryManagerTool extends AbstractMarsToolAndApplication {
        ...
        public void initComponents() {
                ...
                pagingMethodCheckbox
                                .setModel(new DefaultComboBoxModel<>(
                                                new String[] { "NRU", "FIFO", "Segunda chance", "LRU" }));
                                                                ...
                                                                .addGroup(mainPanelLayout.createParallelGroup(
                                                                                ...
                                                                                .addGroup(mainPanelLayout
                                                                                                ...
                                                                                                .addGroup(mainPanelLayout
                                                                                                                .createParallelGroup(
                                                                                                                                GroupLayout.Alignment.LEADING)
                                                                                                                .addComponent(instPageCheckbox,
                                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                                                .addComponent(numPagesCheckbox,
                                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                ...
                                                                                .addGroup(mainPanelLayout
                                                                                                .createSequentialGroup()
                                                                                                .addContainerGap()
                                                                                                .addComponent(pagingMethodCheckbox,
                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                126,
                                                                                                                GroupLayout.PREFERRED_SIZE)))
                                                                .addGap(18, 18, 18)
                                                                                ...
                                                                                .addGroup(GroupLayout.Alignment.TRAILING,
                                                                                                mainPanelLayout
                                                                                                                ...
                                                                                                                .addGroup(mainPanelLayout
                                                                                                                                .createParallelGroup(
                                                                                                                                                GroupLayout.Alignment.LEADING)
                                                                                                                                .addComponent(pagesReplacementsTxt,
                                                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                                                                .addComponent(pagesReplacementsLabel)
                                                                                                                                .addComponent(startButton)
                                                                                                                                .addComponent(missesTxt,
                                                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                                GroupLayout.PREFERRED_SIZE)
                                                                                                                                .addComponent(hitsTxt,
                                                                                                                                                GroupLayout.PREFERRED_SIZE,
                                                                                                                                                GroupLayout.DEFAULT_SIZE,
                                                                                                                                                GroupLayout.PREFERRED_SIZE))
                                                                                                                .addGap(16, 16, 16))
                ...
                mainPanelLayout.setVerticalGroup(
                                mainPanelLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                                .addGroup(mainPanelLayout.createSequentialGroup()
                                                                ...
                                                                .addComponent(hitsTxt, GroupLayout.PREFERRED_SIZE, 16,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addGap(21, 21, 21)
                                                                .addComponent(missesLabel)
                                                                .addPreferredGap(
                                                                                LayoutStyle.ComponentPlacement.UNRELATED)
                                                                .addComponent(missesTxt, GroupLayout.PREFERRED_SIZE, 16,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addGap(18, 18, 18)
                                                                .addComponent(pagesReplacementsLabel)
                                                                .addPreferredGap(
        ...
        public void start() {
                MemoryManager.setPageSize(
                                Integer.parseInt(instPageCheckbox.getModel()
                                                .getElementAt(instPageCheckbox.getSelectedIndex())));
                MemoryManager.setMaxNumPages(
                                Integer.parseInt(numPagesCheckbox.getModel()
                                                .getElementAt(numPagesCheckbox.getSelectedIndex())));
